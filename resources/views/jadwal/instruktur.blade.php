...
<section class="content">
                ...
                <div class="col-md-12">
                    ...
                    <table id="custom-table" class="table table-striped table-bordered dataTable customTable">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td style='width:1%'><input type="checkbox" data-id="{{ $key->instruktur_r->id }}" class="selection"
    ...
    <div class="modal fade" id="modal-konfirmasi" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
        aria-hidden="true">
        <form action="{{ url('jadwal/kirimaccount/instruktur') }}" class="form-horizontal" id="formDelete" name="formDelete"
