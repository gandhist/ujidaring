            ...
            <table id="data-tables" class="table table-striped table-bordered dataTable customTable">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>{{$key->badan_usaha_r->nama_bu}}</td>
                        <td style='text-align:left'>
                            {{$key->nama_tuk}}</td>
                        <td data-toggle="tooltip" data-placement="bottom" data-html="true"
                            title="{{$key->provinsi_r->nama}}">{{$key->provinsi_r->nama_singkat}}</td>
                        <td data-toggle="tooltip" data-placement="bottom" data-html="true"
                            title="Kota : {{$key->kota_r->nama}}
                            <br>Alamat : {{$key->alamat}}
                            <br>No Tlp / No Hp : {{$key->no_hp}}
                            <br>Email : {{$key->email}}
                            <br>Web : {{$key->web}}
                            ">{{$key->kota_r->singkatan_kota}}</td>
                        <td>{{$key->pengelola}}</td>
                        <td data-toggle="tooltip" data-placement="bottom" data-html="true"
                            title="Jabatan : {{$key->jab_kontak_p}}
                            <br>No Hp : {{$key->no_hp_kontak_p}}
                            <br>Email : {{$key->email_kontak_p}}
                            ">{{$key->kontak_p}}</td>
                        <td>{{$key->keterangan}}</td>
                        <td data-toggle="tooltip" data-placement="bottom" data-html="true"
                            title="NPWP : {{$key->npwp}}
                            <br>No Rek : {{$key->no_rek}}
                            <br>Bank : {{$key->bank_r->nama_bank}}
                            ">{{$key->nama_rek}}</td>
