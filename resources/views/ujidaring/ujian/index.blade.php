...
<h3 id="demo">Ujian Pilihan Ganda</h3>
        ...
        <div class="col-lg-6">
            <nav aria-label="Navigasi soal ujian">
                <ul class="nav" role="tablist">
                  <li class="page-item active" role="presentation"><a class="page-link" href="#soal-1" aria-control="soal-1" role="tab" data-toggle="tab">1</a></li>
