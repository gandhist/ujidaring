                                ...
                                <table id="custom-table"
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            @php
                                            $rowspan = DB::table('uji_modul_rundown')->where('id_rundown','=',$key->id_rundown)->where('deleted_at','=',null)->count();
                                            @endphp
                                            ...
                                            @endif
                                            @php
                                            $jumlahsoalpre = DB::table('uji_soal_pg_pre')->where('id_jadwal_modul','=',$key->id_jadwal_modul)->where('deleted_at','=',null)->count(); 
                                            $jumlahsoalpost = DB::table('uji_soal_pg_post')->where('id_jadwal_modul','=',$key->id_jadwal_modul)->where('deleted_at','=',null)->count(); 
                                            @endphp
                                            <td>{{$key->jadwal_modul_r->modul_r->modul}}</td>
                                            <td style="width:5%;text-align:right">{{$jumlahsoalpre}}</td>
                                            @php
                                            $prequizbenar =
                                            DB::table('uji_jawaban_peserta_pg_pre')->where('id_jadwal_modul','=',$key->jadwal_modul_r->id)->where('is_true','=',1)->where('id_peserta','=',$Peserta->id)->where('deleted_at','=',null)->count();
                                            $prequizsalah =
                                            DB::table('uji_jawaban_peserta_pg_pre')->where('id_jadwal_modul','=',$key->jadwal_modul_r->id)->where('is_true','=',0)->where('id_peserta','=',$Peserta->id)->where('deleted_at','=',null)->count();
                                            $postquizbenar =
                                            DB::table('uji_jawaban_peserta_pg_post')->where('id_jadwal_modul','=',$key->jadwal_modul_r->id)->where('is_true','=',1)->where('id_peserta','=',$Peserta->id)->where('deleted_at','=',null)->count();
                                            $postquizsalah =
                                            DB::table('uji_jawaban_peserta_pg_post')->where('id_jadwal_modul','=',$key->jadwal_modul_r->id)->where('is_true','=',0)->where('id_peserta','=',$Peserta->id)->where('deleted_at','=',null)->count();
                                            ...
                                            <td style="width:5%;text-align:center">
                                                @php
                                                $jumlahtm =
                                                DB::table('uji_jawaban_tm')->where('id_jadwal_modul','=',$key->jadwal_modul_r->id)->where('id_peserta','=',$Peserta->id)->where('deleted_at','=',null)->count();
                                                @endphp
                                ...
                                <table id="custom-table"
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            @php
                                            $rowspanqs =
                                            DB::table('uji_jawaban_evaluasi')->groupBy('id_instruktur')->select('id_instruktur')->where('id_jadwal','=',$key->id_jadwal)->where('id_peserta','=',$key->id_peserta)->where('tanggal','=',$key->tanggal)->where('deleted_at','=',null)->get();
                                            @endphp
                                ...
                                <table id="custom-table"
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            @php
                                            $dataabsen =
                                            DB::table('uji_absen')->where('tanggal','=',$key->tanggal)->where('id_peserta','=',$Peserta->id)->where('deleted_at','=',null)->first();
                                            @endphp
