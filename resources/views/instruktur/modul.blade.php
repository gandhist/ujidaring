                                        ...
                                        <form name="formAdd" id="formAdd" enctype="multipart/form-data">
                                            ...
                                            <tr>
                                                ...
                                                <td style="text-align:center">
                                                    @if($key->materi)
                                                    <a href="{{ url('uploads/materi/'.$key->materi) }}"
                                                        class="btn btn-success">Materi</a>
                                                    @endif
                                                </td>
                                                <td style="text-align:center">
                                                    <input type="file" class="form-control" id="materi_{{ $key->id }}"
                                                        name="materi_{{ $key->id }}" value="">
                                                    <span id="materi_{{ $key->id }}" class="help-block">
                                                        {{ $errors->first('materi_'.$key->id) }} </span>
                                                </td>
                                                <td style="text-align:center">
                                                    <input type="text" class="form-control" id="link_{{ $key->id }}"
                                                        name="link_{{ $key->id }}" value="{{ $key->link }}">
                                                    <span id="link_{{ $key->id }}" class="help-block">
                                                        {{ $errors->first('link_'.$key->id) }} </span>
                                                </td>
                                            </tr>
                                            @endforeach
                                        </form>
