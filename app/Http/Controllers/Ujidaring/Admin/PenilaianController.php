...
class PenilaianController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('ujidaring.penilaian.index')->with(compact('data','jumlahjadwal'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('ujidaring.penilaian.create')->with(compact('data','jumlahPeserta','Peserta','jumlahSoalPg','jumlahSoalEssay'));
