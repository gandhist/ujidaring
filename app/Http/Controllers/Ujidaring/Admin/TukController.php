...
use App\Models\Ujidaring\MasterTuk;
use App\Models\Ujidaring\BadanUsaha;
use App\Models\Ujidaring\MasterProvinsi;
use App\Models\Ujidaring\MasterKota;
use App\Models\Ujidaring\MasterDaftarBank;
...
class TukController extends Controller
{
    ...
    {
        $data = MasterTuk::all();
        return view('ujidaring.tuk.index')->with(compact('data'));
    }
    ...
    public function create()
    {
        ...
        return view('ujidaring.tuk.create')->with(compact('badanusaha','provinsi','kota','bank'));
    }
    ...
    public function edit($id)
    {
        ...
        $badanusaha = BadanUsaha::all();
        $provinsi = MasterProvinsi::all();
        $kota = MasterKota::where('provinsi_id',$tuk->prov)->get();
        $bank = MasterDaftarBank::all();
        return view('ujidaring.tuk.edit')->with(compact('badanusaha','provinsi','kota','bank','tuk'));
    }
    ...
    public function update(Request $request)
    {
        ...
        $request->validate(
            ...
            MasterTuk::find($request->id_tuk)->update($data);
    ...
    public function destroy(Request $request)
    {
        ...
        MasterTuk::whereIn('id',$idData)->update($user_data);
