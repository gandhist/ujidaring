...
class ModulController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('ujidaring.modul.index')->with(compact('data'));
    }
    ...
    public function create()
    {
        ...
        return view('ujidaring.modul.create')->with(compact('jenisusaha','bidang'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('ujidaring.modul.edit')->with(compact('jenisusaha','bidang','ms_modul','srtf_bid_alat','detailModul'));
    }
