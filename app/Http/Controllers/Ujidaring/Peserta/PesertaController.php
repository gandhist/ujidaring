...
class PesertaController extends Controller
{
    ...
    public function index()
    {
        ...
        if($is_absen){
            ...
            return view('ujidaring.peserta.dashboard')->with(compact('peserta','is_allow_uji','is_allow_tugas','rd','is_pre_quis','is_post_quis','is_ketua','anggota_klp','is_pkl','is_tugas'));
        }
    }
    ...
    public function tugas(){
        ...
        return view('ujidaring.peserta.tugas')->with(compact('peserta'));
    }
    ...
    public function kuisioner(){
        ...
        return view('ujidaring.peserta.kuisioner')->with(compact('peserta','rd'));
    }
    ...
    public function absen(){
        ...
        return view('ujidaring.peserta.absen')->with(compact('data','allow_cekout','allow_cekin','allow_tugas'));
    }
    ...
    public function ujian_pg(Request $request){
        ...
        return view('ujidaring.ujian.pg')->with(compact('peserta','pg','soal_essay','modul_today'));
    }
    ...
    public function makalah(){
        ...
        return view('ujidaring.peserta.makalah')->with(compact('peserta'));
    }
    ...
    public function presentasi(){
        ...
        return view('ujidaring.peserta.presentasi')->with(compact('peserta'));
    }
    ...
    public function bukaMateri($id){
        ...
        return view('ujidaring.pdfviewer')->with(compact('url')); // pdf cant download
        return redirect($url);
